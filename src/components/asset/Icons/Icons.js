import { AiOutlineUser, AiOutlineLogout, AiOutlineEye } from 'react-icons/ai';
...
import { MdHelpOutline, MdBlockFlipped } from 'react-icons/md';
import { BiLink, BiSkipNext, BiTrash } from 'react-icons/bi';
import {
    IoSettingsOutline,
    IoLanguage,
    IoChevronBackSharp,
...
import { FaSpinner, FaCommentDots, FaPlay, FaPause } from 'react-icons/fa';
import { HiCheckCircle, HiLockClosed } from 'react-icons/hi';
import { BsFillHeartFill, BsCheckLg, BsFillCaretDownFill, BsHeart, BsThreeDots } from 'react-icons/bs';
...
const Icons = {
    ...
    Play: () => <FaPlay />,
    PlayViews: () => <IoPlayOutline />,
    Pause: () => <FaPause />,
    Mute: () => <RiVolumeMuteFill />,
    Lock: () => <HiLockClosed />,
    Link: () => <BiLink />,
    ...
    MuteOn({ className, width = '4rem', height = '4rem' }) {
        return (
            <svg
                className={className}
                width={width}
    ...
    MuteOff({ className, width = '4rem', height = '4rem' }) {
        return (
            <svg
                className={className}
                width={width}
    ...
    Line({ className, width = '2.6rem', height = '2.6rem' }) {
        return (
            <svg
                className={className}
                width={width}
    ...
    Facebook({ className, width = '2.6rem', height = '2.6rem' }) {
        return (
            <svg
                className={className}
                width={width}
    ...
    Twitter({ className, width = '2.6rem', height = '2.6rem' }) {
        return (
            <svg
                className={className}
                width={width}
    ...
    CoppyPath({ className, width = '2.6rem', height = '2.6rem' }) {
        return (
            <svg
                className={className}
                width={width}
    ...
    Email({ className, width = '2.6rem', height = '2.6rem' }) {
        return (
            <svg
                className={className}
                width={width}
    ...
    WhatsApp({ className, width = '2.6rem', height = '2.6rem' }) {
        return (
            <svg
                className={className}
                width={width}
    ...
    Printerest({ className, width = '2.6rem', height = '2.6rem' }) {
        return (
            <svg
                className={className}
                width={width}
    ...
    Home({ className, width = '2.4rem', height = '2.4rem' }) {
        return (
            <svg
                className={className}
                width={width}
    ...
    HomeSolid({ className, width = '2.4rem', height = '2.4rem' }) {
        return (
            <svg
                className={className}
                width={width}
    ...
    ShareSolid({ className, width = '2.4rem', height = '2.4rem' }) {
        return (
            <svg
                className={className}
                width={width}
    ...
    More({ className, width = '2.4rem', height = '2.4rem' }) {
        return (
            <svg
                className={className}
                width={width}
    ...
    Users({ className, width = '2.4rem', height = '2.4rem' }) {
        return (
            <svg
                className={className}
                width={width}
    ...
    UsersSolid({ className, width = '2.4rem', height = '2.4rem' }) {
        return (
            <svg
                className={className}
                width={width}
    ...
    Live({ className, width = '2.4rem', height = '2.4rem' }) {
        return (
            <svg
                className={className}
                width={width}
    ...
    LiveSolid({ className, width = '2.4rem', height = '2.4rem' }) {
        return (
            <svg
                className={className}
                width={width}
    ...
    Search({ className, width = '2.4rem', height = '2.4rem' }) {
        return (
            <svg
                className={className}
                width={width}
    ...
    Qrcode({ className, width = '1rem', height = '1rem' }) {
        return (
            <svg
                className={className}
                width={width}
    ...
    MailBox({ className, width = '1rem', height = '1rem' }) {
        return (
            <svg
                className={className}
                width={width}
    ...
    Google({ className, width = '1rem', height = '1rem' }) {
        return (
            <svg
                className={className}
                width={width}
    ...
    Apple({ className, width = '1rem', height = '1rem' }) {
        return (
            <svg
                className={className}
                width={width}
    ...
    Instagram({ className, width = '1rem', height = '1rem' }) {
        return (
            <svg
                className={className}
                width={width}
    ...
    KakaoTalk({ className, width = '1rem', height = '1rem' }) {
        return (
            <svg
                className={className}
                width={width}
    ...
    Message({ className, width = '1.6rem', height = '1.6rem' }) {
        return (
            <svg
                className={className}
                width={width}
    ...
    CommentHeart({ className, width = '1.6rem', height = '1.6rem' }) {
        return (
            <svg
                data-e2e=""
                className={className}
    ...
    CommentHeartSolid({ className, width = '1.6rem', height = '1.6rem' }) {
        return (
            <svg
                className={className}
                width={width}
    ...
    Plus({ className, width = '1.6rem', height = '1.6rem' }) {
        return (
            <svg
                className={className}
                width={width}
    ...
    MessageSolid({ className, width = '2.4rem', height = '2.4rem' }) {
        return (
            <svg data-e2e="" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M12 24C18.6274 24 24 18.6274 24 12C24 5.37258 18.6274 0 12 0C5.37258 0 0 5.37258 0 12C0 18.6274 5.37258 24 12 24Z"
    ...
    Smile({ className, width = '2rem', height = '2rem' }) {
        return (
            <svg
                className={className}
                width={width}
    ...
    Menu({ className, width = '2rem', height = '2rem' }) {
        return (
            <svg
                className={className}
                width={width}
    ...
    FrientTag({ className, width = '2rem', height = '2rem' }) {
        return (
            <svg
                className={className}
                width={width}
